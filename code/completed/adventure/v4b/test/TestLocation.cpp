...
TEST_CASE("Test Location", "[location]")
{
    SECTION("Test construction from data")
    {
        SECTION("Basic features")
        {
            ...
            v4b::Location location {data::simpleLocationDataVector[0]};
        ...
        {
            v4b::World world {
                v4b::WorldFactory::create(data::simpleLocationDataVector)};
        ...
        {
            v4b::World world {
                v4b::WorldFactory::create(data::dungeonLocationDataVector)};
