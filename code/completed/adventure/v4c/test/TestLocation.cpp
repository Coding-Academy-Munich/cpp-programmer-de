...
TEST_CASE("Test Location", "[location]")
{
    SECTION("Test construction from data")
    {
        SECTION("Basic features")
        {
            ...
            v4c::Location location {data::simpleLocationDataVector[0]};
        ...
        {
            v4c::World world {
                v4c::WorldFactory::create(data::simpleLocationDataVector)};
        ...
        {
            v4c::World world {
                v4c::WorldFactory::create(data::dungeonLocationDataVector)};
