...
TEST_CASE("Test Location", "[location]")
{
    SECTION("Test construction from data")
    {
        SECTION("Basic features")
        {
            ...
            v5a::Location location {data::simpleLocationDataVector[0]};
        ...
        {
            v5a::World world {
                v5a::WorldFactory::create(data::simpleLocationDataVector)};
        ...
        {
            v5a::World world {
                v5a::WorldFactory::create(data::dungeonLocationDataVector)};
