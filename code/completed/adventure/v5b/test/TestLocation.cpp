...
TEST_CASE("Test Location", "[location]")
{
    SECTION("Test construction from data")
    {
        SECTION("Basic features")
        {
            ...
            v5b::Location location {data::simpleLocationDataVector[0]};
        ...
        {
            v5b::World world {
                v5b::WorldFactory::create(data::simpleLocationDataVector)};
        ...
        {
            v5b::World world {
                v5b::WorldFactory::create(data::dungeonLocationDataVector)};
