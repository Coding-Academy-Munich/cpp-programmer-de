...
#pragma once
#ifndef COMPLETED_ADVENTURE_V5C_LIB_PLAYEROBSERVER_H
#define COMPLETED_ADVENTURE_V5C_LIB_PLAYEROBSERVER_H
...
template <> struct std::hash<adventure::v5c::PlayerObserver> {
    std::size_t operator()(
        const adventure::v5c::PlayerObserver& observer) const noexcept
    {
        return std::hash<const adventure::v5c::PlayerObserver*> {}(&observer);
    }
};

#endif // COMPLETED_ADVENTURE_V5C_LIB_PLAYEROBSERVER_H
