...
TEST_CASE("Test Location", "[location]")
{
    SECTION("Test construction from data")
    {
        SECTION("Basic features")
        {
            ...
            v5c::Location location {data::simpleLocationDataVector[0]};
        ...
        {
            v5c::World world {
                v5c::WorldFactory::create(data::simpleLocationDataVector)};
        ...
        {
            v5c::World world {
                v5c::WorldFactory::create(data::dungeonLocationDataVector)};
