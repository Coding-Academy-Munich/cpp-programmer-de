...
#ifndef COMPLETED_ADVENTURE_V6A_LIB_ACTIONTAG_H
#define COMPLETED_ADVENTURE_V6A_LIB_ACTIONTAG_H
...
private:
    std::bitset<static_cast<std::size_t>(ActionTag::TAG_SET_SIZE)> tagBits_;
};

} // namespace adventure::v6a

#endif // COMPLETED_ADVENTURE_V6A_LIB_ACTIONTAG_H
