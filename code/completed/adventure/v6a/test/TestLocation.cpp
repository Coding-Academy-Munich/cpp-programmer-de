...
TEST_CASE("Test Location", "[location]")
{
    SECTION("Test construction from data")
    {
        SECTION("Basic features")
        {
            ...
            v6a::Location location {data::simpleLocationDataVector[0]};
        ...
        {
            v6a::World world {
                v6a::WorldFactory::create(data::simpleLocationDataVector)};
        ...
        {
            v6a::World world {
                v6a::WorldFactory::create(data::dungeonLocationDataVector)};
