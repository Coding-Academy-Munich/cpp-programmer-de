...
#pragma once
#ifndef COMPLETED_LIBRARY_V2C_LIB_BOOK_H
#define COMPLETED_LIBRARY_V2C_LIB_BOOK_H
...
public:
    ...
    [[nodiscard]] bool GetEdition() const { return info->GetEdition(); }

    [[nodiscard]] BookInfo& GetInfo() const { return *info; }

    [[nodiscard]] bool HasAuthor(const std::string& basicString) const;
...
#endif // COMPLETED_LIBRARY_V2C_LIB_BOOK_H
